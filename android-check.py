...
def main(argv=None):
    ...
    parser = git_create_parser(description='Android commit check')
    ...
    # Setup to do check.
    path = os.getcwd()
    patterns = settings.ANDROID_FULL_PATTERNS
    checker = Checker(path, patterns, settings.ANDROID_IGNORES, settings.ANDROID_CHECKS)
